...
public class MrezoveBodyVis extends JFrame {
    ...
    public void drawOval(Graphics g, double sx, double sy, double rx, double ry) {
        g.drawOval(marg + (int) (sx*cellSize - rx*cellSize), marg +
                        (int) (sy*cellSize - ry*cellSize),
                (int) (2*rx*cellSize), (int) (2*ry*cellSize));
        g.setColor(Color.blue);
        g.fillOval(marg + (int)(sx*cellSize) - pointSize,
                marg + (int)(sy*cellSize) - pointSize,
                2*pointSize, 2*pointSize);
    }
    ...
    public void drawGridMarkersInOval(Graphics g, double sx, double sy, double rx, double ry) {
        g.setColor(Color.red);
...
//        drawGridMarkersInCircle(g, 6.3, 5.2, 3);
        ...
        drawOval(g, 4.5,4.5,4,3);
        drawGridMarkersInOval(g, 4.5,4.5,4,3);
        //drawOval(g, 6, 6, 1, 3);
        //drawGridMarkersInOval(g, 6, 6, 1, 3);
